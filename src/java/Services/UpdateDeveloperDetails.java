...
public class UpdateDeveloperDetails {
    ...
    , boolean Ceiling, boolean Welding, boolean Aluminium){
        ...
        DBConnection();
        String query = "UPDATE developer SET mason="+Masson+", tile="+Tile+
                ", carpentor="+Carpentor+", plumber="+Plumber+", electrician="
                +Electrician+", painter="+Painter+", concrete_slab="+Concrete_slab
                +", ceiling="+Ceiling+", welding="+Welding+", aluminium="
                +Aluminium+" WHERE user_name='"+UserName+"'";
