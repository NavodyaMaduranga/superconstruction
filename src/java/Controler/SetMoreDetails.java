...
public class SetMoreDetails extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        HardwareAddress = request.getParameter("Hardware Address");
        ...
        if(Type.equals("Developer")){
            ...
            idd.setDetails(UserName, Mason, Tile, Carpentor, Plumber, Electrician, 
        ...
        else if(Type.equals("HardwareOwner") && cmd.getHardwareOwnerValue()){
        ...
        else if(Type.equals("Transpoter") && cmd.getTranspoterValue()){
