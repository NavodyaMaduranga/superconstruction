...
public class Update extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(Data.equals("Basic")){
            ...
            if(!value){
                session.setAttribute("UMessage", "Please donot remove details "
                ...
                uud.login(UserName, FirstName, LastName, BirthDay, Address, City, Email, Mobile);
            ...
            if(Type.equals("Developer")){
                ...
                utd.login(UserName, VehicleNumber, Model, Chargeper1Km);
